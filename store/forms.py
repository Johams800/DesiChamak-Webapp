...
class ContactForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'firstname':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter First Name Here'}),
                   'lastname':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Last Name Here'}),
                   'email':forms.EmailInput(attrs={'class':'form-control', 'placeholder':'Enter Email Here', 'autocomplete':'email'}),
                   'phone':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Phone Number Here'}),
                   'message':forms.Textarea(attrs={'class':'form-control', 'placeholder': 'Tell Us How We Can Help'}),}
